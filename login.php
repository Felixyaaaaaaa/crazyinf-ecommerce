...
<body>
  ...
  <section style="background-image: url('img/background_login.jpg'); background-size: cover; background-attachment: fixed; background-position: center; min-height: 100vh; display: flex; justify-content: center; align-items: center;">
                                ...
                                <div class="card-body px-lg-5 text-black pt-5 pb-5">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <p class="mb-0">Do you still not have an account? <a href="register.php" class="text-dark-50 fw-bold">Register</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
